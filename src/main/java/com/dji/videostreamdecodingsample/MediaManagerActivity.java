...
public class MediaManagerActivity extends Activity implements View.OnClickListener{
    ...
    protected void onDestroy() {
        ...
        VideoDecodingApplication.getCameraInstance().setMode(SettingsDefinitions.CameraMode.SHOOT_PHOTO, new CommonCallbacks.CompletionCallback() {
            @Override
    ...
    void initUI() {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(MediaManagerActivity.this, OrientationHelper.VERTICAL,false);
    ...
    private void initMediaManager() {
        if (VideoDecodingApplication.getProductInstance() == null) {
            ...
            if (null != VideoDecodingApplication.getCameraInstance() && VideoDecodingApplication.getCameraInstance().isMediaDownloadModeSupported()) {
                mMediaManager = VideoDecodingApplication.getCameraInstance().getMediaManager();
                if (null != mMediaManager) {
                    mMediaManager.addUpdateFileListStateListener(this.updateFileListStateListener);
                    mMediaManager.addMediaUpdatedVideoPlaybackStateListener(this.updatedVideoPlaybackStateListener);
                    VideoDecodingApplication.getCameraInstance().setMode(SettingsDefinitions.CameraMode.MEDIA_DOWNLOAD, new CommonCallbacks.CompletionCallback() {
                        @Override
            ...
            } else if (null != VideoDecodingApplication.getCameraInstance()
                    && !VideoDecodingApplication.getCameraInstance().isMediaDownloadModeSupported()) {
